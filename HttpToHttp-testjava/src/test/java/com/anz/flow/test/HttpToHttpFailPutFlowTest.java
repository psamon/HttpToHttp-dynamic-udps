...
import com.ibm.broker.config.proxy.RecordedTestData;
		 ...
		 * 
		 */
		public class HttpToHttpFailPutFlowTest extends FlowTest {
			...
			private static final String MESSAGE_FORMAT = "FailPutMessageFormat.xml";
			...
			public void injectData() throws IOException, ConfigManagerProxyPropertyNotInitializedException, ConfigManagerProxyLoggedException {
				...
				String message = IOUtils.toString(HttpToHttpFailPutFlowTest.class.getResourceAsStream(TEST_FILE_001));
				String jsonBlob = TransformUtils.getBlob(message);
				String messageFormat = IOUtils.toString(HttpToHttpFailPutFlowTest.class.getResourceAsStream(MESSAGE_FORMAT));
