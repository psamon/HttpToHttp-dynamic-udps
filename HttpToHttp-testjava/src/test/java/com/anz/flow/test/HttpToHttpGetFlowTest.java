 ...
 * 
 */
public class HttpToHttpGetFlowTest extends FlowTest {
	...
	private void testGetResult() throws ConfigManagerProxyPropertyNotInitializedException, XPathExpressionException, SAXException, IOException, ParserConfigurationException {
		...
		String retrievedMessage = getNodeOutputJsonStringFromBlob(dataList.get(0));
		
		logger.info("retrievedMessage = {}", retrievedMessage);
		
		assertEquals("Hello World from Java_SpringBoot", retrievedMessage);
