...
import com.ibm.broker.config.proxy.RecordedTestData;
		 ...
		 * 
		 */
		public class HttpToHttpFailEmptyFlowTest extends FlowTest {
			...
			private static final String MESSAGE_FORMAT = "FailEmptyMessageFormat.xml";
			...
			public void injectData() throws IOException, ConfigManagerProxyPropertyNotInitializedException, ConfigManagerProxyLoggedException {
				...
				String message = IOUtils.toString(HttpToHttpFailEmptyFlowTest.class.getResourceAsStream(TEST_FILE_001));
				//String jsonBlob = TransformUtils.getBlob(message);
				String messageFormat = IOUtils.toString(HttpToHttpFailEmptyFlowTest.class.getResourceAsStream(MESSAGE_FORMAT));
	...
	private void testOutputResult() throws ConfigManagerProxyPropertyNotInitializedException, XPathExpressionException, SAXException, IOException, ParserConfigurationException {
